...
def test_post_constructs_with_properties():
    post = Post(1, "Test Content", 1, "2023-12-10 15:30:00")
    assert post.id == 1
...
def test_format_post():
    post = Post(1, "Test Content", 1, "2023-12-10 15:30:00")
    assert str(post) == "Post(1, Test Content, 1, 2023-12-10 15:30:00)"
...
def test_posts_are_equal():
    post1 = Post(1, "Test Content", 1, "2023-12-10 15:30:00")
    post2 = Post(1, "Test Content", 1, "2023-12-10 15:30:00")
    assert post1 == post2
...
def test_post_isvalid():
    assert Post(1, "", 1, "2023-12-10 15:30:00").is_valid() == False
    assert Post(1, "Test Content", "", "2023-12-10 15:30:00").is_valid() == False
    assert Post(1, None, 1, "2023-12-10 15:30:00").is_valid() == False
    assert Post(1, "Test Content", None, "2023-12-10 15:30:00").is_valid() == False
    assert Post(None, "Test Content", 1, datetime(2023, 12, 10, 15, 30, 00)).is_valid() == True
...
def test_post_errors(): 
    assert Post(1, "", 1, "2023-12-10 15:30:00").generates_errors() == "Post content can't be blank"
